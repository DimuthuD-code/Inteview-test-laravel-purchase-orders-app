...
<div class="row mt-4">
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('product.edit_validation') }}" method="post">
                    @csrf
                    <div class="form-group mb-3">
                        <label for=""><b>SKU Code</b></label>
                        <input type="text" name="sku_code" id="sku_code" class="form-control" placeholder="SKU Code" value="{{ $data->sku_code }}" />
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="sku_name" id="sku_name" class="form-control" placeholder="SKU Name" value="{{ $data->sku_name }}" />
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="mrp" id="mrp" class="form-control" placeholder="MRP" value="{{ $data->mrp }}" />
                        @if($errors->has('mrp'))
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="distributor_price" id="distributor_price" class="form-control" placeholder="Distributor Price" value="{{ $data->distributor_price }}" />
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-9 p-0">
                                <input type="text" name="volume" id="volume" class="form-control" placeholder="Weight or Volume" value="{{ $data->volume }}" />  
